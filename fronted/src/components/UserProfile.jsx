            ...
            <div className="flex flex-col pb-5">
                <div className="relative flex flex-col mb-7">
                    <div className="flex flex-col justify-center items-center">
                        <img src={randomImage} alt="user-picture" className="w-full h-370 2xl:h-510 shadow-3xl object-cover" />
                    ...
                    <div className="absolute top-0 z-1 right-0 p-2">
                        {userId === User?.sub && (
                            <button type='button'
                                    className='bg-mainColor flex justify-center items-center p-3 rounded-xl text-gray-600 shadow-xl cursor-pointer outline-none'
                                    onClick={() => logout()}
                                >
